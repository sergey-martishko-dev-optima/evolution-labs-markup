    ...
    <div class="container">
      <div class="row-line">
        <div class="column-w50">
          <h3 class="contact-form__title">For leasing inquiries and
            additional information,
            please enter your
            contact information.</h3>
          <a class="desktop download" target="_blank" href="https://pdfobject.com/pdf/sample.pdf">DOWNLOAD BROCHURE</a>
        </div>
        <div class="column-w50">
          <form class="form">
            <div class="item">
            ...
            <div class="item mobile">
              <a class="download" target="_blank" href="https://pdfobject.com/pdf/sample.pdf">DOWNLOAD BROCHURE</a>
            </div>
          </form>
        </div>
      </div>
  ...
  .contact-form {
    ...
    .form {
      ...
      .input-field {
        ...
        border: 0;
        border-bottom: 1px solid #0B0511;
        width: 100%;
        font: normal normal 300 34px/42px 'Graphik', sans-serif;
        &::placeholder {
          color: #0B0511;
        }
