    ...
    <div class="container-fluid">
      ...
      <div class="row-line">
        ...
        <div class="column-w50 part-right">
          <p class="description">Coming to the lively mixed-use neighborhood of Pike & Rose, EvolutionLabs North Bethesda will be the premier, walkable, urban life science opportunity in Maryland, developed by Stonebridge.</p>
        </div>
      </div>
    </div>
  </section>
